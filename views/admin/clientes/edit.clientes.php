...
<div class="container-fluid">
    <?php 
        foreach (find("clientes", getParam("id")) as $cliente) {
    ?>

    <form action="/Laboratorio1/clientes/<?php echo $cliente["id"]; ?>/update" method="post">
        ...
        <div class="card mt-4">
            <div class="card-header">
                ...
                Editar cliente: <?php echo $cliente["nombres"]." ".$cliente["apellidos"]; ?>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-12">
                        <div class="mb-3">
                            ...
                            value = "<?php echo $cliente["dui"]; ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-sm-12">
                        <div class="mb-3">
                            ...
                            placeholder="Ingresa el email del cliente" value = "<?php echo $cliente["email"]; ?>"  required>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="mb-3">
                            ...
                            placeholder="Dirección del cliente"><?php echo $cliente["direccion"]; ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
