    ...
    function sidebar() {
        ...
        <div class="border-end bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                ...
                <a class="list-group-item list-group-item-action list-group-item-light p-3" href="/laboratorio1/home">
                    <i class="fa-solid fa-home"></i>
                    Home
                </a>

                <a class="list-group-item list-group-item-action list-group-item-light p-3" href="/laboratorio1/clientes">
                    <i class="fa-solid fa-people-group"></i>
                    Clientes
                </a>

                <a class="list-group-item list-group-item-action list-group-item-light p-3" href="/laboratorio1/mascotas">
                    <i class="fa-solid fa-dog text-info"></i>
                    Mascotas
                </a>

                <a class="list-group-item list-group-item-action list-group-item-light p-3" href="/laboratorio1/medicamentos">
                    <i class="fa-solid fa-prescription-bottle text-success"></i>
                    Medicamentos
                </a>

                <a class="list-group-item list-group-item-action list-group-item-light p-3" href="/laboratorio1/usuarios">
